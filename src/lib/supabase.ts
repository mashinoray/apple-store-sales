...
const supabaseUrl = import.meta.env.VITE_SUPABASE_URL || 'https://absgpsdvpfhjlecchpav.supabase.co';
const supabaseAnonKey = import.meta.env.VITE_SUPABASE_KEY || 'sb_publishable_oCUzAQRdIzfPcvuLuP8g_g_rcKGPQLA';
